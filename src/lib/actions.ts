...
export async function addBook(name: string, user: User): Promise<void> {
    try {
        await axios.post("https://107.20.240.135:8088/fin-api/labels",
            {
                name: name,
                user: user,
            },
...
export async function editBook(id: number, newName: string): Promise<Labels> {
    try {
        const response = await axios.put("https://107.20.240.135:8088/fin-api/labels",
            {
                id: id,
                name: newName,
            },
...
export async function deleteBook(id: number): Promise<void> {
    try {
        await axios.delete(`https://107.20.240.135:8088/fin-api/labels/${id}`,
            {
                headers: {
                    "Accept": "*/*",
                    "Authorization": `Basic ${btoa(`${localStorage.getItem("authEmail")}:${localStorage.getItem("authPw")}`)}`,
...
export async function addCategory(name: string, transactionType: TransactionType, user: User): Promise<void> {
    try {
        await axios.post("https://107.20.240.135:8088/fin-api/transaction-groups",
            {
                name: name,
...
export async function editCategory(id: number, newName: string, newTransactionType: TransactionType | null, user: User): Promise<Category> {
    try {
        const response = await axios.put("https://107.20.240.135:8088/fin-api/transaction-groups",
            {
                id: id,
                name: newName,
...
export async function deleteCategory(id: number): Promise<void> {
    try {
        await axios.delete(`https://107.20.240.135:8088/fin-api/transaction-groups/${id}`,
            {
                headers: {
                    "Accept": "*/*",
                    "Authorization": `Basic ${btoa(`${localStorage.getItem("authEmail")}:${localStorage.getItem("authPw")}`)}`,
...
export async function addTransaction(transcation: TransactionProp): Promise<Transaction> {
    try {
        const response = await axios.post("https://107.20.240.135:8088/fin-api/transactions",
            transcation,
            {
                headers: {
                    "Accept": "*/*",
...
export async function editTransaction(transaction: TransactionProp): Promise<Transaction | null> {
    try {
        const response = await axios.put("https://107.20.240.135:8088/fin-api/transactions",
            transaction,
            {
                headers: {
                    "Accept": "*/*",
...
export async function deleteTransaction(id: number): Promise<void> {
    try {
        await axios.delete(`https://107.20.240.135:8088/fin-api/transactions/${id}`,
            {
                headers: {
                    "Accept": "*/*",
                    "Authorization": `Basic ${btoa(`${localStorage.getItem("authEmail")}:${localStorage.getItem("authPw")}`)}`,
...
export async function sendFeedback(feedback: FeedbackProp): Promise<void> {
    try {
        await axios.post("https://107.20.240.135:8088/fin-api/feedback/submit",
            feedback,
            {
                headers: {
                    "Accept": "*/*",
...
export async function sendUploadFile(file: FormData): Promise<UploadResult> {
    try {
        const response = await axios.post("https://107.20.240.135:8088/fin-api/transactions/parse",
            file,
            {
                headers: {
                    "Accept": "*/*",
...
export async function addRecurringRule(rule: RecurringTransactionProp): Promise<void> {
    try {
        await axios.post("https://107.20.240.135:8088/fin-api/recurring-transactions",
            rule,
            {
                headers: {
                    "Accept": "*/*",
...
export async function editRecurringRule(transaction: RecurringTransactionProp): Promise<void> {
    try {
        await axios.put("https://107.20.240.135:8088/fin-api/recurring-transactions",
            transaction,
            {
                headers: {
                    "Accept": "*/*",
...
export async function deleteRecurringRule(id: number): Promise<void> {
    try {
        await axios.delete(`https://107.20.240.135:8088/fin-api/recurring-transactions/${id}`,
            {
                headers: {
                    "Accept": "*/*",
                    "Authorization": `Basic ${btoa(`${localStorage.getItem("authEmail")}:${localStorage.getItem("authPw")}`)}`,
